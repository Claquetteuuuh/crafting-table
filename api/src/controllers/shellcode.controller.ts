...
export class ShellcodeController {
    ...
    generate = async (req: Request, res: Response) => {
        try {
            ...
            let shellcodeBuffer: Buffer;

            if (options.payload === 'test/messagebox') {
                shellcodeBuffer = Buffer.from([
                ...
                shellcodeBuffer = await this.dockerService.generateShellcode(options);
            }
            ...
            res.json({
                ...
                shellcode: shellcodeBuffer.toString('base64')
            });
